...
- 内置 OAuth 传输身份当前对应 Codex CLI `0.149.0`、Claude Code `2.1.240` 和 Antigravity 2.0 `2.9.1`。macOS 上 Antigravity 优先读取已安装应用的版本；受控部署可通过 `CLIPAL_OAUTH_ANTIGRAVITY_VERSION` 覆盖。
