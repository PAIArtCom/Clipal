...
- The bundled OAuth transport identities track Codex CLI `0.149.0`, Claude Code `2.1.240`, and Antigravity 2.0 `2.9.1`. On macOS, the Antigravity identity uses the installed application's version when available; `CLIPAL_OAUTH_ANTIGRAVITY_VERSION` can override it for a controlled deployment.
