...
- Current protocol scope: Codex OAuth supports OpenAI `/v1/responses*`; Claude OAuth supports `/v1/messages` and `/v1/messages/count_tokens`; Antigravity OAuth supports Gemini-compatible `generateContent`, `streamGenerateContent`, `countTokens`, and model listing.
